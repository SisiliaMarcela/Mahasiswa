                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> NamaDosen </th><td> {{ $dosen->namaDosen }} </td></tr><tr><th> EmailDosenUPH </th><td> {{ $dosen->emailDosenUPH }} </td></tr><tr><th> EmailDosenNonUph </th><td> {{ $dosen->emailDosenNonUph }} </td></tr>
                                </tbody>
                            </table>
                        </div>
